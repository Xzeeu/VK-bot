...
#Написать как поступить, когда подавать документы, лучшие вызы по направлению
    ...
    if rez == Hnature:
        ...
        qusend(event, None, 'По этому типу профессии ВУЗы Курганской области (КГУ и КГСХА) предлагают следующие специальности (в скобках ср.балл ЕГЭ): \n Экология и природопользование, география, ЕГЭ: русский язык, математика, география (150) \n Биология, ЕГЭ: химия, биология, русский язык (167)\n Агрономия, ЕГЭ: биология, математика, русский язык (167) \n Землеустройство и кадастры, ЕГЭ: математика, русский язык, физика (145)')
        qusend(event, None, '❓ Получить боллее подробную информацию можно получить на сайте ВУЗов: \n Курганский государственный университет: https://abit.kgsu.ru/ \n Курганская государственная сельскохозяйственная академия имени Т.С.Мальцева: https://www.ksaa.zaural.ru/abiturientu')
    ...
    if rez == Htechnics:
        ...
        qusend(event, None, 'По этому типу профессии ВУЗы Курганской области предлагают следующие специальности (в скобках ср.балл ЕГЭ): \n Сроительство, Машиностроение ЕГЭ: математика, физика, русский язык \n Теплоэнергетика и теплотехника, Электроэнергетика и электротехника, ЕГЭ: математика, физика, русский язык (150), Управление в технических системах, ЕГЭ: математика, физика, русский язык (160)') 
        qusend(event, None, '❓ Получить боллее подробную информацию можно получить на сайте ВУЗов: \n Курганский государственный университет: https://abit.kgsu.ru/')
    ...
    if rez == HH:
        ...
        qusend(event, None, 'По этому типу профессии ВУЗы Курганской области предлагают следующие специальности (в скобках ср.балл ЕГЭ): \n Социалогия, ЕГЭ: математика, обществознание, русский язык (198) \n Жуналистика, ЕГЭ: литература, русский язык, экзамен по направлению подготовки (246) \n Педагогической образование, ЕГЭ: обществознание, русский язык, профессиональное испытание (198)')
        qusend(event, None, '❓ Получить боллее подробную информацию можно получить на сайте ВУЗов: \n Курганский государственный университет: https://abit.kgsu.ru/ \n Шадринский государственный педагогический университет: http://shgpi.edu.ru/spec/informacija-dlja-postupajushchikh/')
    ...
    if rez == Hsymbol:
        ...
        qusend(event, None, 'По этому типу профессии ВУЗы Курганской области предлагают следующие специальности (в скобках ср.балл ЕГЭ): \n Математика, ЕГЭ: математика, физика, русский язык (145 \n Прикладная информатика, информатика и вычислительная техника,Программная инженерия, Информационная безопасность, ЕГЭ: математика, информатика\физика, русский язык (140)')
        qusend(event, None, '❓ Получить боллее подробную информацию можно получить на сайте ВУЗов: \n Курганский государственный университет: https://abit.kgsu.ru/')
    ...
    if rez == Himahe:
        ...
        qusend(event, None, 'По этому типу профессии ВУЗы Курганской области предлагают следующие специальности (в скобках ср.балл ЕГЭ): \n Дизайн, ЕГЭ: литература, русский язык, экзамен по направлению подготовки')
        qusend(event, None, '❓ Получить боллее подробную информацию можно получить на сайте ВУЗов: \n Курганский государственный университет: https://abit.kgsu.ru/')
